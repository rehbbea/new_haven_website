...
class EdgeInstagramApi {
	...
	const INSTAGRAM_CODE = 'edgt_instagram_code';
	const INSTAGRAM_USER_ID = 'edgt_instagram_user_id';
	const INSTAGRAM_TOKEN = 'edgt_instagram_access_token';
	const INSTAGRAM_TOKEN_LONG_LIVED = 'edgt_instagram_access_token_long_lived';
	const INSTAGRAM_TOKEN_LONG_LIVED_TIME = 'edgt_instagram_access_token_long_lived_time';

	const FACEBOOK_CODE = 'edgt_facebook_code';
	const FACEBOOK_TOKEN = 'edgt_facebook_access_token';

	const CONNECTION_TYPE = 'edgt_connection_type';
	 ...
	 * @return stdClass
	 *
	 * @see EdgeInstagramApi::instagramExchangeCodeForToken()
	 */
