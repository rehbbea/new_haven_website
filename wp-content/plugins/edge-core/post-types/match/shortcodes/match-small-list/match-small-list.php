...
class MatchSmallList implements Lib\ShortcodeInterface {
	...
	public function __construct() {
		$this->base = 'edgt_match_small_list';
	...
	public function vcMap() {
		if (function_exists('vc_map')) {
			vc_map(array(
					'name'                      => esc_html__('Match Small List', 'edge-core'),
					'base'                      => $this->getBase(),
	...
	public function render($atts, $content = null) {
		...
		if ($queryResults->have_posts()) {
			while ($queryResults->have_posts()) {
				...
				$html .= edgt_core_get_shortcode_module_template_part('match-small-list/templates/match', 'match', '', $new_params);
			}
	...
	public function getMatchHolderClasses($params) {
        ...
        $classes[] = 'edgt-match-small-list-holder';
