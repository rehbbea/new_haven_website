<?php
namespace Eldritch\Modules\Dropcaps;
...
class Dropcaps implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$html = edge_core_get_core_shortcode_template_part('templates/dropcaps-template', 'dropcaps', '', $params);
	...
	private function getDropcapsClass($params) {
		return ($params['type'] !== '') ? 'edgt-'.$params['type'] : '';
	}
}