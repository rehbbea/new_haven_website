<?php
namespace Eldritch\Modules\GoogleMap;
...
class GoogleMap implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map(
			array(
				'name'                    => esc_html__('Google Map', 'edge-core'),
				'base'                    => $this->base,
				...
				'params'                  => array(
					...
					array(
						...
						'value'       => array(
							esc_html__('No', 'edge-core')  => 'false',
							esc_html__('Yes', 'edge-core') => 'true'
						),
						'save_always' => true,
	...
	public function render($atts, $content = null) {
		...
		$html = edge_core_get_core_shortcode_template_part('templates/google-map-template', 'google-map', '', $params);
