<?php
namespace Eldritch\Modules\Blockquote;
...
class Blockquote implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$html = edge_core_get_core_shortcode_template_part('templates/blockquote-template', 'blockquote', '', $params);
