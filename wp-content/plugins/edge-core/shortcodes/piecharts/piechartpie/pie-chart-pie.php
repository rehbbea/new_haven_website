...
class PieChartPie implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map(array(
			'name'                      => esc_html__('Pie Chart 2 (Pie)', 'edge-core'),
			'base'                      => $this->getBase(),
	...
	public function render($atts, $content = null) {
		...
		$html = edge_core_get_core_shortcode_template_part('templates/pie-chart-pie', 'piecharts/piechartpie', '', $params);
