...
if (!function_exists('eldritch_edge_dark_theme_styles')) {
	/**
	 * Function that includes dark theme styles
	 */
	function eldritch_edge_dark_theme_styles() {
		wp_enqueue_style('eldritch-edge-dark-theme', EDGE_ASSETS_ROOT . '/css/dark-theme.css');
	}
...
if (!function_exists('eldritch_edge_google_fonts_styles')) {
	...
	function eldritch_edge_google_fonts_styles() {
		$is_enabled = boolval( apply_filters( 'eldritch_edge_filter_enable_google_fonts', true ) );
...
if (!function_exists('eldritch_edge_scripts')) {
	...
	function eldritch_edge_scripts() {
		...
		wp_enqueue_script('eldritch-edge-modules', EDGE_ASSETS_ROOT . '/js/modules.min.js', array('jquery'), false, true);

		if (eldritch_edge_load_blog_assets()) {
			wp_enqueue_script('eldritch-edge-blog', EDGE_ASSETS_ROOT . '/js/blog.min.js', array('jquery'), false, true);
		}
