...
if ( ! function_exists( 'eldritch_edge_disable_google_font' ) ) {
	/**
	 * Function that remove Google fonts loading
	 *
	 * @return bool
	 */
	function eldritch_edge_disable_google_font() {
		return 'no' !== eldritch_edge_options()->getOptionValue( 'enable_google_fonts' );
	}
	
	add_filter( 'eldritch_edge_filter_enable_google_fonts', 'eldritch_edge_disable_google_font' );
}
	...
	function eldritch_edge_merge_fonts() {
        ...
        if (isset($eldritch_fonts_array)) {
            ...
            if (is_array($native_fonts) && count($native_fonts)) {
	            ...
	            if ( eldritch_edge_is_plugin_installed( 'core' ) && $is_enabled ) {
		            $eldritch_fonts_array = array_merge( $native_fonts, $eldritch_fonts_array );
	            } else {
		            $eldritch_fonts_array = $native_fonts;
	            }
            }
        }
	}
