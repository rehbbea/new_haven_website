...
(function ($) {
    ...
    function edgtInitVideoBackground() {
	    ...
	    $('.edgt-section .edgt-video-wrap .edgt-video').each(function(){
    ...
    function edgtDisableScroll() {
        ...
        if (window.addEventListener) {
            window.addEventListener('wheel', edgtWheel, {passive: false});
        }
    ...
    function edgtEnableScroll() {
        if (window.removeEventListener) {
            window.removeEventListener('wheel', edgtWheel, false);
        }
