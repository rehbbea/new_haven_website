	...
	function eldritch_edge_general_options_map() {
		...
		eldritch_edge_add_admin_field(
			array(
				...
				'type'          => 'yesno',
				'default_value' => 'yes',
				'label'         => esc_html__( 'Enable Google Fonts', 'eldritch' ),
				'parent'        => $panel_design_style,
				'args'          => array(
					"dependence" => true,
					"dependence_hide_on_yes" => "",
					"dependence_show_on_yes" => "#edgt_google_fonts_container"
				)
			)
		);
		
		$google_fonts_container = eldritch_edge_add_admin_container(
			array(
				'parent'          => $panel_design_style,
